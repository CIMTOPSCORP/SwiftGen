...
namespace :release do
  ...
  task :github => :artifactbundle do
    ...
    begin
      release = client.release_for_tag("CIMTOPSCORP/#{repo_name}", version)
      client.update_release(release.url, tag_name: version, name: version, body: body)
    rescue Octokit::NotFound
      release = client.create_release("CIMTOPSCORP/#{repo_name}", version, name: version, body: body)
    end
  ...
  task :homebrew do
    ...
    archive_url = "https://github.com/CIMTOPSCORP/SwiftGen/archive/#{tag}.tar.gz"
    ...
    Dir.chdir(formulas_dir) do
      ...
      sh 'git remote add SwiftGen https://github.com/CIMTOPSCORP/homebrew-core 2>/dev/null || true'
